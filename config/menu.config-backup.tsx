    ...
    children: [
      {
        title: 'Employees',
        children: [
          { title: 'Employee List', path: '/hris-admin/employees' },
          {
            title: 'Employee Profile',
            path: '/hris-admin/employees/profile',
            disabled: true,
          },
        ],
      },
      {
        ...
        children: [
          {
            title: 'Departments',
            path: '/hris-admin/organization/departments',
            disabled: true,
          },
          {
            title: 'Positions',
            path: '/hris-admin/organization/positions',
            disabled: true,
          },
        ],
      },
        ...
        children: [
          {
            ...
            path: '/hris-admin/attendance/log',
            disabled: true,
          },
          {
            title: 'Work Schedules',
            path: '/hris-admin/attendance/schedules',
            disabled: true,
          },
        ],
      },
        ...
        children: [
          {
            ...
            path: '/hris-admin/leave/requests',
            disabled: true,
          },
          {
            title: 'Leave Types',
            path: '/hris-admin/leave/types',
            disabled: true,
          },
        ],
      },
